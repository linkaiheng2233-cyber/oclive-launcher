/**
 * 启动器界面：大白话说明（供 HelpHint 问号气泡分段展示）。英文见 `launcherHintsEn.ts`。
 */

export const HINTS_ZH = {
  START_GUIDE: [
...
export type LauncherHelpHintSet = keyof typeof HINTS_ZH;

export const LAUNCHER_HINT_START_GUIDE = HINTS_ZH.START_GUIDE;
export const LAUNCHER_HINT_VERSION_PAGE = HINTS_ZH.VERSION_PAGE;
export const LAUNCHER_HINT_VERSION_QUICK_LINKS = HINTS_ZH.VERSION_QUICK_LINKS;
export const LAUNCHER_HINT_VERSION_REPO_EDITOR = HINTS_ZH.VERSION_REPO_EDITOR;
export const LAUNCHER_HINT_VERSION_REPO_OCLIVE = HINTS_ZH.VERSION_REPO_OCLIVE;
export const LAUNCHER_HINT_VERSION_LOCAL_VS_REMOTE = HINTS_ZH.VERSION_LOCAL_VS_REMOTE;
export const LAUNCHER_HINT_VERSION_ACTIONS = HINTS_ZH.VERSION_ACTIONS;
export const LAUNCHER_HINT_GH_URL_PASTE = HINTS_ZH.GH_URL_PASTE;
export const LAUNCHER_HINT_OCLIVE_GH_DL = HINTS_ZH.OCLIVE_GH_DL;
export const LAUNCHER_HINT_EDITOR_GH_DL = HINTS_ZH.EDITOR_GH_DL;
export const LAUNCHER_HINT_EXE_PATH_PASTE = HINTS_ZH.EXE_PATH_PASTE;
export const LAUNCHER_HINT_ASSISTANT = HINTS_ZH.ASSISTANT;
export const LAUNCHER_HINT_LOGS = HINTS_ZH.LOGS;
export const LAUNCHER_HINT_TITLEBAR_TOOLS = HINTS_ZH.TITLEBAR_TOOLS;
